...
gulp.task("build-docs-readme-html-inline", function() {
  return gulp
...
gulp.task(
  "build-docs-readme",
  gulp.series("build-docs-readme-html-from-md", "build-docs-readme-html-inline")
);
...
gulp.task("build-docs", gulp.series("build-docs-readme", "build-docs-app"));

gulp.task("build-create-static-resources", function(cb) {
  jsonfile.readFile("./build/resources.json", function(err, resources) {
...
gulp.task("build-copy-sources", function() {
...
gulp.task("extract-legacy-online-resources", function(cb) { 
  request(
    {
      uri:
        "https://www.library.manchester.ac.uk/using-the-library/staff/research/my-research-essentials/online-resources/",
      method: "GET"
    },
    function(error, response, body) {
      if (error) {
        ...
        $(".mle_item").each(function(i, elem) {
          ...
          const resource = {
            ...
            title: $(this)
              ...
              .trim(),
            description: $(this)
              .find(".mle_description")
              .text()
              .trim(),
            duration: $(this)
              .find(".mle_detail")
              .find("li")
              .find("span.fine-detail")
              .eq(0)
              .text()
              .trim(),
            format: $(this)
        ...
        jsonfile.writeFileSync(
          "./legacy-exports/" + dateString + ".json",
          resources
        );
...
gulp.task("dev", gulp.parallel("dev-server", "dev-watch"));
